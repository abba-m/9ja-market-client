...
function PostsView() {
  ...
  const getUserPosts = async () => {
    const [result, error] = await sendRequest(fetch(`${process.env.REACT_APP_SERVER_URL}/api/posts/me`, {
      headers: {
  ...
  return (
    <Box>
      <Heading mb={4} color="secondary" size="lg">Posts by {firstName}</Heading>
